...
async fn start_node_impl(
	...
	let (block_import, mut telemetry, telemetry_worker_handle, frontier_backend, storage_override) =
		params.other;
	...
	// If tokenSymbol is not set in the para chain's chainspec file, the default value is 18.
