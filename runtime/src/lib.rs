...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("parachain-magnet-runtime"),
	impl_name: create_runtime_str!("parachain-magnet-runtime"),
	authoring_version: 1,
	spec_version: 1,
	impl_version: 0,
...
mod runtime {
	...
	pub type EVMUtils = pallet_evm_utils;

	//Magnet
	#[runtime::pallet_index(51)]
	pub type OrderPallet = pallet_on_demand;
	#[runtime::pallet_index(61)]
	pub type Pot = pallet_pot;
	#[runtime::pallet_index(62)]
	pub type Assurance = pallet_assurance;
	#[runtime::pallet_index(63)]
	pub type Liquidation = pallet_liquidation;
	#[runtime::pallet_index(64)]
	pub type BulkPallet = pallet_bulk;
	//Contracts
